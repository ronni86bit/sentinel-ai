          ...
          orderedCitations.map((cit) => {
            ...
            return (
              ...
              >
                ...
                <div className={cn(
                  "text-xs text-zinc-700 dark:text-zinc-300 leading-relaxed font-sans bg-zinc-50 dark:bg-zinc-900/60 p-2.5 rounded-md border border-zinc-100 dark:border-zinc-800/70 transition-all",
